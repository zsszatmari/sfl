...
namespace Gear
{
    ...
    private:
        static shared_ptr<GroupedPlaylist> create(const shared_ptr<SortedSongArray> &base, const string &name, const vector<string> &groupBy);
        GroupedPlaylist(const shared_ptr<SortedSongArray> &base, const string &name, const vector<string> &groupBy);
        ...
        shared_ptr<SortedSongArray> _filteredArray;

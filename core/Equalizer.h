...
namespace Gear
{
	...
	public:
		...
		virtual std::vector<std::string> bandLabels() const;
		...
		virtual bool currentModified() const override;
		...
		virtual void setWiden(bool on) override;

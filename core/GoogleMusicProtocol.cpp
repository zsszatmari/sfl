...
#define method GoogleMusicProtocol::
    ...
    shared_ptr<Json::Value> method loadExplore()
    {
        ...
        auto response = call("explore/loadexplore", jsonWithSecond(second));
        
        return response;

    }
    
    shared_ptr<Json::Value> method searchSongs(const string &filter)
    {
        ...
        auto response = call("search", jsonWithSecond(second));
    ...
    shared_ptr<Json::Value> method fetchArtist(const string &artistId)
    {
        ...
        return call("fetchartist", jsonWithSecond(value));
    }
    
    shared_ptr<Json::Value> method fetchAlbum(const string &albumId)
    {
        ...
        return call("fetchalbum", jsonWithSecond(value));
    }
    
    shared_ptr<Json::Value> method fetchRadioFeed(const string &radioId)
    {
        ...
        return call("radio/fetchradiofeed", jsonWithSecond(value));
    }
    
    shared_ptr<Json::Value> method fetchSharedSongs(const string &token)
    {
        ...
        return call("loadsharedplaylist", jsonWithSecond(value));
    }
    
    shared_ptr<Json::Value> method fetchRatedSongs()
    {
        // [["l4u6892ukf1k",1],[]]:
        Json::Value value(Json::arrayValue);
        
        return call("getephemthumbsup", jsonWithSecond(value));
    }

    shared_ptr<Json::Value> method addSongsToLocker(const vector<string> &songIds)
    {
        ...
        return call("addsongstolocker", jsonWithSecond(value));
    }
    
    shared_ptr<Json::Value> method loadRadio()
    {
        ...
        return call("radio/loadradio" ,jsonWithSecond(value));
    }
    
    shared_ptr<Json::Value> method createStation(const string &songId, const string &name, int type)
    {
        ...
        return call("radio/createstation", jsonWithSecond(value));
    }
    ...
    void method deleteStation(const string &radioId)
    {
        ...
        call("radio/deletestation", jsonWithSecond(value));
    }
    ...
    void method deletePlaylist(const string &playlistId)
    {
        ...
        auto ret = call("deleteplaylist", parameters);
    ...
    void method getAllSongs(const function<void(const Json::Value &)> &songRetrieveBlock)
    {
        // initial call
        _cancelling = false;
        ...
        auto streamer = _connection->streamingCall("streamingloadalltracks", params);
        for (;;) {
            Json::Value chunk;
    ...
    shared_ptr<Json::Value> method getListOfPlaylists()
    {
        string str = _connection->callPure("listen");
        ...
        */
        ...
        if (!ret) {
            return doGetListOfPlaylistsOld(str);
        }
        return ret;
    }
    ...
    shared_ptr<Json::Value> method getPlaylist(const string &playlistId)
    {
        // [["yra5o0x0ibu7",1],["80125b73-ebe6-4f34-ab7a-c8ea27b74e7d"]]:
        Json::Value value(Json::arrayValue);
        value.append(playlistId);
        
        return call("loaduserplaylist", jsonWithSecond(value));
    }
    
    shared_ptr<Json::Value> method addPlaylistEntries(const vector<string> &songs, const string &playlist)
    {
        /*
         addtoplaylist
        ...
        auto ret = call("addtoplaylist", parameters);
#define DEBUG_ADDPLAYLISTENTRIES
    ...
    shared_ptr<Json::Value> method createPlaylist(const vector<string> &songIds, const string &title)
    {
        ...
        return call("createplaylist", jsonWithSecond(value));
    }
    ...
    void method changePlaylistName(const string &name, const string &playlist)
    {
        ...
        call("editplaylist", jsonWithSecond(value));
    }
    ...
    void method changePlaylistOrder(const string &playlist, const vector<string> &movedSongs, const vector<string> &movedEntries, const string &beforeEntry, const string &afterEntry)
    {
        ...
        auto ret = call("changeplaylistorder", parameters);
        if (!ret) {
    ...
    void method changeSongs(const Json::Value &changeDictionaries)
    {
        ...
        if (transformed.size() > 0) {
            ...
            auto ret = call("modifytracks", jsonWithSecond(container));
            if (!ret) {
        ...
        if (!recordPlayback.empty()) {
            for (auto &songId : recordPlayback) {
                ...
                auto ret = call("recordplaying", value);
            }
        }
    }
    ...
    {
        return _connection->call(name, param);
    }

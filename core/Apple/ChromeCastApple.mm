...
#define method ChromeCastApple::
	...
	void method probeAsync(const function<void(const shared_ptr<CastDevice> &)> &aCallback)
	{
        ...
        dispatch_async(dispatch_get_main_queue(),^{
            ...
            static ChromeCastAppleHelper *helper = nil;
            // make new instances every time. the old instance does not seem to be useful anymore
            browser = [[NSNetServiceBrowser alloc] init];
            helper = [[ChromeCastAppleHelper alloc] init];

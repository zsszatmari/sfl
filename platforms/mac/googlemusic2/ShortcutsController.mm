...
NSString * const kKeyShortcutVolumeUp = @"ShortcutVolumeUp";
NSString * const kKeyShortcutVolumeDown = @"ShortcutVolumeDown";
...
- (void)awakeFromNib
{
    ...
    keysToViews = @{kKeyShortcutThumbsUp:self.thumbsUpView,
                   ...
                   kKeyShortcutVolumeUp:self.volumeUpView,
                   kKeyShortcutVolumeDown:self.volumeDownView};
...
- (void)hotkeyPressed:(int)keyId
{
    ...
    } else if ([key isEqualToString:kKeyShortcutVolumeUp]) {
        [[AppDelegate sharedDelegate].mainWindowController volumeIncrement:0.1f];
    } else if ([key isEqualToString:kKeyShortcutVolumeDown]) {
        [[AppDelegate sharedDelegate].mainWindowController volumeIncrement:-0.1f];
    }
}
